...
function dokan_get_reports_charts() {
    $charts = array(
        ...
        'charts' => array(
            ...
            "sales_by_day"      => array(
                'title'       => __( 'Sales by date(s)', 'dokan' ),
                'description' => '',
...
function dokan_seller_sales_statement() {
    ...
    <form method="get" class="dokan-form-inline report-filter dokan-clearfix" action="">
        ...
        <input type="submit" name="dokan_report_filter" class="dokan-btn dokan-left dokan-btn-sm dokan-btn-theme" style="margin-right:5px;" value="<?php _e( 'Show', 'dokan' ); ?>" />
        <input type="submit" name="dokan_statement_export_all"  class="dokan-btn dokan-left dokan-btn-sm dokan-btn-danger dokan-btn-theme" style="display:none;"value="<?php esc_attr_e( 'Export All', 'dokan' ); ?>">
    </div>
    </form>
    <?php
    global $wpdb;
    ...
    <table class="table table-striped">
        <thead>
            <tr>
                ...
                <th style="display:none;"><?php _e( 'Shipping', 'dokan' ); ?></th>
                <th><?php _e( 'Tax', 'dokan' ); ?></th>
                <th style="display:none;"><?php _e( 'Balance', 'dokan' ); ?></th>
            </tr>
        </thead>
        <tbody>
            <?php if( $opening_balance ) { ?>
                <tr style="display:none;">
                    ...
                    <td><?php echo '--'; ?></td>
                    <td><?php echo '--'; ?></td>
                    <td style="display:none;"><?php echo wc_price( $opening_balance ); ?></td>
                </tr>
...
<label for="to">&nbsp;</label>
            <input type="submit" name="dokan_report_filter" class="dokan-btn dokan-right dokan-btn-sm dokan-btn-theme" value="<?php _e( 'Show', 'dokan' ); ?>" />
        </div>
    </form>
    <?php
...
function dokan_top_sellers() {
 ...
 <label for="to">&nbsp;</label>
        ...
        <input type="submit" class="dokan-btn dokan-left dokan-btn-sm dokan-btn-theme" value="<?php _e( 'Show', 'dokan' ); ?>" />
    </form>
