...
<?php if ( $is_valid ): ?>
    <form method="post" action="" class="dokan-form-horizontal vendor-staff register">
        ...
        <div class="dokan-form-group">
            <label class="dokan-w3 dokan-control-label" for="title"><?php _e( 'Company', 'dokan' ); ?><span class="required"> *</span></label>
            <div class="dokan-w5 dokan-text-left">
                <input id="phone" name="phone" required value="<?php echo esc_attr( $phone ); ?>" placeholder="<?php _e( 'Company', 'dokan' ); ?>" class="dokan-form-control input-md" type="text">
            </div>
        </div>
