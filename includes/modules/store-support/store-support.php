    ...
    function add_support_btn_title_input( $current_user, $profile_info ){
        ...
        ?>
          <div class="dokan-form-group" style="display:none;">
            ...
            <div class="dokan-form-group support-enable-check" style="display:none;">
                <label style="display:none;" class="dokan-w3 dokan-control-label" for="dokan_support_btn_name"><?php _e( 'Support Button text', 'dokan' ); ?></label>

                <div class="dokan-w5 dokan-text-left" style="display:none;">
