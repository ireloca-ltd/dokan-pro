...
global $post;
    ...
    <header class="dokan-dashboard-header">
        ...
        <h1 class="entry-title"><?php _e( $title , 'dokan' ); ?></h1>
            <span class="dokan-add-product-link">
                <a href="<?php _e( $booking_url.'new-product','dokan' );?>" class="dokan-btn dokan-btn-theme dokan-right dokan-add-new-product"><i class="fa fa-briefcase">&nbsp;</i> <?php _e( 'Add New Product', 'dokan' ) ?></a>
            </span>
