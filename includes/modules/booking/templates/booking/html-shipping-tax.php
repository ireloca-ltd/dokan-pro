...
<div class="dokan-product-shipping-tax hide_if_virtual dokan-edit-row dokan-clearfix dokan-border-top <?php echo ! $wc_shipping_enabled ? 'woocommerce-no-shipping' : '' ?> <?php echo ! $wc_tax_enabled ? 'woocommerce-no-tax' : '' ?>">
    <div class="dokan-section-heading" data-togglehandler="dokan_product_shipping_tax">
        <h2><i class="fa fa-percent" aria-hidden="true"></i> <?php _e( 'Tax', 'dokan' ); ?></h2>
        <p><?php _e( 'Manage tax for this product', 'dokan' ); ?></p>
        ...
        <div class="dokan-clearfix dokan-tax-container">
            <div class="dokan-tax-product-options">
                ...
                <div class="dokan-form-group content-half-part">
                    <label class="dokan-control-label" for="_tax_class"><?php _e( 'Tax Class (Standard = UK 20% VAT)', 'dokan' ); ?></label>
                    <div class="dokan-text-left">
